...
public class BufferCalculator {
	...
	public CirculinearBoundary2D createParallelBoundary(
		...
		return CirculinearContourArray2D.createCirculinearContour2DFromCollection(parallelContours);
	}
	...
	public CirculinearContour2D createParallelContour(
		...
		return BoundaryPolyCirculinearCurve2D.createCirculinearContinuousCurve2DFromCollection(parallelCurves,
				contour.isClosed());
	}
	...
	public CirculinearContinuousCurve2D createContinuousParallel(
		...
		// curves
		return PolyCirculinearCurve2D.createCirculinearContinuousCurve2DFromCollection(parallelCurves, curve.isClosed());
	}
	...
	public CirculinearDomain2D computeBuffer(
		...
		return new GenericCirculinearDomain2D(
				CirculinearContourArray2D.createCirculinearContour2DFromCollection(contours2));
	}
	...
	private CirculinearContour2D convertCurveToBoundary (
		...
		if (curve.isClosed())
			return GenericCirculinearRing2D.createGenericCirculinearRing2DFromCollection(curve.smoothPieces());
		
		return BoundaryPolyCirculinearCurve2D.createCirculinearContinuousCurve2DFromCollection(curve.smoothPieces());
	}
