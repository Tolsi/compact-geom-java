...
implements DomainSet2D<T> {
	...
	public static <D extends Domain2D> DomainArray2D<D> createFromCollection(Collection<D> array) {
		return new DomainArray2D<D>(array);
	}
	
	public static <D extends Domain2D> DomainArray2D<D> createFromCollection(D... array) {
		return new DomainArray2D<D>(array);
	}
