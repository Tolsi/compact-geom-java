 ...
 *      CirculinearContourArray2D.createFromCollection(new Circle2D[]{circle1, circle2});
 * </code></pre>
 * @author dlegland
 *
 */
...
extends ContourArray2D<T> implements CirculinearBoundary2D {
	...
	CirculinearContourArray2D<T> createCirculinearContour2DFromCollection(Collection<T> curves) {
