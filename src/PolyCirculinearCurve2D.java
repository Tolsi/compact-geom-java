...
extends PolyOrientedCurve2D<T> implements CirculinearContinuousCurve2D {
    ...
    PolyCirculinearCurve2D<T> createCirculinearContinuousCurve2DFromCollection(Collection<T> curves) {
     ...
     */
    public static <T extends CirculinearContinuousCurve2D> 
    PolyCirculinearCurve2D<T> createCirculinearContinuousCurve2DFromCollection(T... curves) {
    	return new PolyCirculinearCurve2D<T>(curves);
    }
     ...
     */
    public static <T extends CirculinearContinuousCurve2D> 
    PolyCirculinearCurve2D<T> createCirculinearContinuousCurve2DFromCollection(Collection<T> curves, boolean closed) {
     ...
     */
    public static <T extends CirculinearContinuousCurve2D> 
    PolyCirculinearCurve2D<T> createCirculinearContinuousCurve2DFromCollection(T[] curves, boolean closed) {
    	return new PolyCirculinearCurve2D<T>(curves, closed);
    }
	...
	reverse() {
        ...
        return PolyCirculinearCurve2D.createCirculinearContinuousCurve2DFromCollection(curves2, this.closed);
    }
