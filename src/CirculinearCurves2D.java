...
public class CirculinearCurves2D {
	...
	public static CirculinearCurve2D convert(Curve2D curve) {
		...
		if (curve instanceof ContinuousCurve2D) {
			...
			// createFromCollection the resulting CirculinearContinuousCurve2D
		...
		if (curve instanceof CurveSet2D<?>) {
			...
			// createFromCollection the resulting CirculinearContinuousCurve2D
			return CirculinearCurveArray2D.createFromCollection(curves);
		}
	...
	public static Collection<CirculinearContour2D> splitIntersectingContours(
		...
		while (!twins1.isEmpty()) {
			...
			// createFromCollection continuous curve formed only by circulinear elements
			// and add it to the set of curves
			contours.add(BoundaryPolyCirculinearCurve2D.createCirculinearContinuousCurve2DFromCollection(elements, true));
		}
