 ...
 * {@link GJContinuousCurve2D GJContinuousCurve2D} for finite or infinite
 * continuous curves, {@link GJSmoothCurve2D GJSmoothCurve2D} for curves that
 * admit a derivative (and hence a tangent, a curvature...) at each point, 
 * {@link math.geom2d.domain.OrientedCurve2D GJOrientedCurve2D} that are used to
 ...
 */
public interface GJCurve2D extends GJShape2D, Cloneable {
     ...
     */
    public abstract GJPoint2D point(double t);
     ...
     */
    public abstract GJPoint2D firstPoint();
     ...
     */
    public abstract GJPoint2D lastPoint();
     ...
     * 
     * @see #vertices()
     * @return a collection of GJPoint2D.
     */
    public abstract Collection<GJPoint2D> singularPoints();
     ...
     * @return a collection of GJPoint2D.
     */
    public abstract Collection<GJPoint2D> vertices();
     ...
     * @see #point(double)
     */
    public abstract double position(GJPoint2D point);
     ...
     */
    public abstract double project(GJPoint2D point);
     ...
     */
    public abstract Collection<GJPoint2D> intersections(GJLinearShape2D line);

    /**
     * Returns the curve with same trace on the plane with parameterization in
     * reverse order.
     */
    public abstract GJCurve2D reverse();
     ...
     */
    public abstract Collection<? extends GJContinuousCurve2D> continuousCurves();
     ...
     */
    public abstract GJCurve2D subCurve(double t0, double t1);

    /**
     * Transforms the curve by an affine transform. The result is an instance of
     * GJCurve2D.
     */
    public abstract GJCurve2D transform(GJAffineTransform2D trans);

    /**
     * When a curve is clipped, the result is a set of curves.
     */
    public abstract GJCurveSet2D<? extends GJCurve2D> clip(GJBox2D box);
	 ...
	 */
	@Deprecated
    public abstract GJCurve2D clone();
}
